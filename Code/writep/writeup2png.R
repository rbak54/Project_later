...
plot_influenza<-function(parms){
  ...
  png(paste0("../../Writeup/draft plots/favs/",sims,parms[["climate_label"]],"rangelat.png"))
  ...
  png(paste0("../../Writeup/draft plots/favs/lats",sims,parms[["climate_label"]],".png"))
  ...
  png(paste0("../../Writeup/draft plots/lats",sims,parms[["climate_label"]],".png"))
  print(ggplot(data=correlation_df_means_country, aes(x= abs(lat), col=as.factor(mismatch),y= means))+geom_point()+theme_bw()+labs(col="Mismatch") +
          geom_errorbar(aes(ymin=means+errors,ymax=means-errors)) +xlab("Absolute Value of Latitude") +ylab("Mean Correlation") +
          theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15)) + 
          geom_vline(xintercept=23.5))
  ...
  png(paste0("../../Writeup/draft plots/favs/boxandwhisker_facet",sims,parms[["climate_label"]],".png"),width=50* 10,height=50* 5)
  ...
  png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanI",parms[["climate_label"]],sims,parms[["climate_label"]],".png"))
  print(ggplot(data=m,aes(mismatch,mI,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean Proportion Infected")+xlab("Mismatch")+
          ...
          theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  graphics.off()
  png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanro",parms[["climate_label"]],sims,parms[["climate_label"]],".png"),width=50*7.5,height=50* 5)
  print(ggplot(data=m,aes(mismatch,mR,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean R0 Infected")+xlab("Mismatch")+
          ...
          theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  graphics.off()
  png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanI",parms[["climate_label"]],sims,parms[["climate_label"]],".png"))
  ...
  png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanro",parms[["climate_label"]],sims,parms[["climate_label"]],".png"))
  ...
  #model_means_2<-model_means_2[which(model_means_2$mismatch %in% c(0,0.5,1)),]
  ggplot(model_means_2,aes(meanAH,meanR0,group=country))+geom_line() # 
  ggplot(model_means_2,aes(meanAH,meancr,group=country,col=best))+geom_line() # 
  ggplot(model_means_2,aes(meanAH,meanq,group=country,col=best))+geom_line()
  ...
  ggplot(model_means_2,aes(meanT,meanR0,group=country))+geom_line() # 
  ggplot(model_means_2,aes(meanT,meancr,group=country,col=best))+geom_line() # 
  ggplot(model_means_2,aes(meanT,meanq,group=country,col=best))+geom_line() # 
  ...
  png(paste0("../../Writeup/draft plots/favs/",parms[["climate_label_long"]],"sel_I_TIME_DATA.png"))
  model_means_3<-model_means_2[which(model_means_2$country %in% c("El Salvador", "France", "Costa Rica",  "Senegal","Thailand")),] 
  ...
  png(paste0("../../Writeup/draft plots/favs/",parms[["climate_label"]],"AH_MISMATCH.png"))
  ...
  png(paste0("../../Writeup/draft plots/favs/",parms[["climate_label"]],"T_MISMATCH.png"))
  ...
  # png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanI",i,sims,parms[["climate_label"]],".png"))
  ...
  #         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  # graphics.off()
  # png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanro",i,sims,parms[["climate_label"]],".png"),width=50*7.5,height=50* 5)
  ...
  #         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  # graphics.off()
  # png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanI",i,sims,parms[["climate_label"]],".png"))
  ...
  #         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  # graphics.off()
  # png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanro",i,sims,parms[["climate_label"]],".png"))
  ...
  # png(paste0("../../Writeup/draft plots/range_best",sims,parms[["climate_label"]],".png"))
  ...
  #for ah see above
  # graphics.off()
  # png(paste0("../../Writeup/draft plots/favs/boxandwhisker",sims,parms[["climate_label"]],".png"))
  # print(ggplot(data=correlation_df, aes(x= as.factor(mismatch),y= corsI)) +geom_boxplot()  +theme_bw()+xlab("Mismatch") +ylab("Mean Correlation")+
  #         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
  # graphics.off()
  # 
  # png(paste0("../../Writeup/draft plots/erros",sims,parms[["climate_label"]],".png"))
  ...
  #   png(paste0("../../Writeup/draft plots/boxandwhisker_just",i,sims,parms[["climate_label"]],".png"))
  ...
  #   png(paste0("../../Writeup/draft plots/just_",i,sims,parms[["climate_label"]],"rangelat.png"))
...
png(paste0("../../Writeup/draft plots/favs/AHtemp.png"))
...
png(paste0("../../Writeup/draft plots/favs/shiftseverity_meanmeanI",sims,".png"))
print(ggplot(data=m,aes(shift,mI,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean Proportion Infected")+xlab("Shift")+
        geom_errorbar(aes(ymin=mI-smI,ymax=mI+smI),width=50*0.25)+scale_y_continuous(limits = c(0,maxI), breaks = seq(0,maxI,by=0.1))+scale_x_continuous(limits = c(-0.125,1.125), breaks = seq(0,1,by=0.25))+
        theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
graphics.off()
png(paste0("../../Writeup/draft plots/favs/shiftseverity_meanmeanro",sims,".png"),width=50*7.5,height=50* 5)
print(ggplot(data=m,aes(shift,mR,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean R0")+xlab("Shift")+
        ...
        theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
graphics.off()
png(paste0("../../Writeup/draft plots/favs/shiftseverity_maxmeanI",sims,".png"))
...
png(paste0("../../Writeup/draft plots/favs/shiftseverity_maxmeanro",sims,".png"))
...
# #  png(paste0("../../Writeup/draft plots/covidtime_I_shift=",each,sims,parms[["climate_label"]],".png"))
...
#  # graphics.off()
#   
#   #png(paste0("../../Writeup/draft plots/favs/covidtime_R0_shift=",each,sims,parms[["climate_label"]],".png"))
...
#           theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# #  graphics.off()
#   #png(paste0("../../Writeup/draft plots/covidtime_R0_facet_shift=",each,sims,parms[["climate_label"]],".png"))
...
#   #graphics.off()
#   #png(paste0("../../Writeup/draft plots/covidtime_I_facet_shift=",each,sims,parms[["climate_label"]],".png"))
...
png(paste0("../../Writeup/draft plots/favs/selectedseriesR0",".png"),width=50*10,height=50*5)
...
png(paste0("../../Writeup/draft plots/favs/covidtime_R0_peekweek_",sims,".png"),width=50*10,height=50*5)
print(ggplot(data=covid_means_summ,aes(y=peakweek,x=Region))+geom_boxplot()+theme_bw()+ylab("Week of Maximal R0")+xlab("Region")+
        theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
graphics.off()
png(paste0("../../Writeup/draft plots/covidtime_I_peekweek_",sims,".png"))
...
# maxI<-max(m$maI)
# 
# png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanI",parms[["climate_label"]],i,sims,parms[["climate_label"]],".png"))
# print(ggplot(data=m,aes(mismatch,mI,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean Proportion Infected")+xlab("Mismatch")+
#         geom_errorbar(aes(ymin=mI-smI,ymax=mI+smI))+ylim(0,maxI)+
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# png(paste0("../../Writeup/draft plots/favs/mismatchseverity_meanmeanro",parms[["climate_label"]],i,sims,parms[["climate_label"]],".png"),width=50*7.5,height=50* 5)
# print(ggplot(data=m,aes(mismatch,mR,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Mean R0 Infected")+xlab("Mismatch")+
#         geom_errorbar(aes(ymin=mR-smR,ymax=mR+smR))+ylim(0,maxR)+
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanI",parms[["climate_label"]],i,sims,parms[["climate_label"]],".png"))
# print(ggplot(data=m,aes(mismatch,maI,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Maximum Proportion Infected")+xlab("Mismatch")+
#         geom_errorbar(aes(ymin=maI-smaI,ymax=maI+smaI))+ylim(0,maxI)+
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# 
# png(paste0("../../Writeup/draft plots/favs/mismatchseverity_maxmeanro",parms[["climate_label"]],i,sims,parms[["climate_label"]],".png"))
# print(ggplot(data=m,aes(mismatch,maR,group=Region_Combined, colour = Region_Combined))+geom_point()+geom_line()+theme_bw()+ylab("Maximum R0 Infected")+xlab("Mismatch")+
#         geom_errorbar(aes(ymin=maR-smaR,ymax=maR+smaR))+ylim(0,maxR)+
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# 
# png(paste0("../../Writeup/draft plots/shiftseverity_meanmeanI",i,sims,parms[["climate_label"]],".png"))
...
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# png(paste0("../../Writeup/draft plots/favs/shiftseverity_meanmeanro",i,sims,parms[["climate_label"]],".png"),width=50* 7.5,height=50* 5)
...
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# png(paste0("../../Writeup/draft plots/shiftseverity_maxmeanI",i,sims,parms[["climate_label"]],".png"))
...
#         theme(text = element_text(size = 15),axis.text = element_text(size=15),axis.title = element_text(size=15))) 
# graphics.off()
# png(paste0("../../Writeup/draft plots/shiftseverity_maxmeanro",i,sims,parms[["climate_label"]],".png"))
...
# png(paste0("../../Writeup/draft plots/favs/AHTEMPDATA.png"))
...
mismatch_temp<-function(C){
  for (max_cr in c(min(C),(min(C)+max(C))/2,max(C))){
    ...
    colnames(dummy_dataframe)<-c("Temperature","Contact_Rate","Survival_Rate")
    png(paste0("../../Writeup/draft plots/favs/mismatch",max_cr,".png"))
